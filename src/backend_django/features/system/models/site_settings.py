...
class SiteSettings(models.Model):
    ...
    # --- General ---
    company_name = models.CharField(_("Company Name"), max_length=255, default="project_landing")
    ...
    email = models.EmailField(_("Email"), default="info@project_landing.com")
    ...
    # --- SEO & Metadata ---
    meta_title = models.CharField(_("Default Meta Title"), max_length=255, default="project_landing")
